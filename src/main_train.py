...
parser.add_argument("--batch_size", default=1, type=int, help="Batch size used to train the model and to dump images/attributes from dataset")
parser.add_argument("--attributs", default=["Smiling"], nargs="+", help="Name attributs")
#parser.add_argument("--nbr_attr", default=1, type=int, help="Number of sliding attributs")
...
T = Train(lr = args.learning_rate, attributs=args.attributs)
T.training(epochs = args.epochs, batch_size = args.batch_size, weights=args.weights)
